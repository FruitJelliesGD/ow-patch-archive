...
Fixed a bug with patch notes truncation for the Taiwanese locale Fixed a bug with specific hero ultimate voicelines playing both their friendly and enemy team variations

### Heroes

Ashe Fixed a bug with an Incorrect shadow displayed across the hood of the Little Red skin Lucio Fixed a bug with Lucio being able to switch to Heal Song while stunned Reinhardt Fixed a bug with fire strike appearing invisible for allies Roadhog Fixed a bug that allowed Roadhog to hook Baptiste's Immortality Field Wrecking Ball Fixed a bug where Wrecking Ball could hit an enemy much faster than intended with Roll Damage
