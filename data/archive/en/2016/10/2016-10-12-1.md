...
*开发者注：So far, we haven't seen any indication that Ana is too strong overall, but her ultimate charges a little too fast, especially considering the impact it can have on a match. Also, her Biotic Grenades are getting a small boost to help her hit multiple targets.*
...
*开发者注：This change will help Widowmaker acquire new targets more quickly and speed up her reaction time in fast-paced situations.*
...
*开发者注：Junkrat can be an extremely effective hero in the right hands, but RIP-Tire often felt underpowered when compared to his counterparts.*
