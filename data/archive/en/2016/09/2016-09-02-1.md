...
> 日期: 2016-09-02 · 站点: en · 来源: https://overwatch.blizzard.com/en-us/news/patch-notes/live/2016/09
...
*开发者注：Defense Matrix was too efficient when tapped repeatedly, instead of being held. Now, the recovery delay matches the ability cooldown.*
...
*开发者注：Mei has an interesting toolkit, but her ultimate often felt like it was too difficult to use effectively. Consequently, it felt weak compared to many other ultimate abilities. The freeze effect has been piercing barriers for some time now, but the projectile would still be blocked. Now, you can throw it down exactly where you want it, so it’s much easier to utilize the full radius effectively.*
...
*开发者注：If players managed to counter or avoid McCree's ultimate, it would often regenerate very quickly since only half of the ultimate charge was spent. Now, this ultimate works like every other ultimate that has a duration.*
...
*开发者注：Resurrection now allows teammates to jump back into the fight more quickly, which should help Mercy survive after activating her ultimate. Mercy's healing is also getting a boost to solidify her role as a strong, single-target healer.*
...
*开发者注：Thanks to Lúcio's speed increase, he was almost a must pick in every lineup.*
...
*开发者注：This change means that hooked targets will be less likely to slide along walls, potentially ending up in an odd place after they've been reeled in.*
...
*开发者注：These changes will make burst-firing feel more reliable and increase his effectiveness at longer ranges.*
...
*开发者注：Altering the size of projectiles in flight had too many unintended side effects to keep in the game, at least in its current form. We will continue watching this and make additional changes if necessary. We’re also making quick melee more consistent when interacting with enemy abilities.*
...
*开发者注：The balance changes that were implemented in previous patches have eliminated the need for Watchpoint: Gibraltar to have an extra checkpoint.*
