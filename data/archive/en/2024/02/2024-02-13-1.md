...
Given the significant changes to our heroes and the addition of a new skill tier, this reset is designed to give all players a chance to climb higher than ever before. All ranks in Role Queue and Open Queue in Competitive Play have been reset to Unranked.
...
Antarctic Peninsula Fixed lighting in some areas of the map. King's Row Fixed areas of the map that were missing collision. Midtown Fixed some locations that could cause some heroes to become stuck Shambali Monastery Fixed a location of the map that displayed incorrect textures.
