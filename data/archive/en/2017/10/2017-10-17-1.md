...
*开发者注：A recent bug fix slowed Lúcio’s Wall Ride. This change compensates for the reduced speed.*
...
*开发者注：Valkyrie no longer resets or reduces Resurrect’s cooldown. Instead, it now provides an extra 'charge,' allowing you to revive an ally even if it is still on cooldown. If the bonus charge hasn’t been spent when Valkyrie ends, it will be removed.*
