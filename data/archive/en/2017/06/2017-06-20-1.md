...
> 日期: 2017-06-20 · 站点: en · 来源: https://overwatch.blizzard.com/en-us/news/patch-notes/live/2017/06
...
*开发者注：McCree’s ultimate can deal a lot of damage if it has a lot of time to build up, but it was often too difficult to get even a small amount of damage out before being stopped or killed. These changes make it more flexible and powerful.*
...
*开发者注：Roadhog’s head was abnormally large compared to similarly-sized characters, so we’re reducing its size to increase his survivability. The Scrap Gun changes reduce the power of his hook combo and alternate fire burst damage potential while still keeping his DPS roughly the same.*
...
*开发者注：The new “Hero Damage Done” statistic is the same as the old “Damage Done” statistic, but it doesn’t include damage done to barriers, only damage against heroes and placed objects (e.g. Torbjörn’s turret). That number can be found in the new “Barrier Damage Done” or “All Damage Done” statistics. However, since “Hero Damage Done” and “Barrier Damage Done” are brand new, their averages will only be based on time played since they were added.*
